...
def predict():
    ...
    if not all(col in descriptors.columns for col in required_columns):
        return render_template('index_2.html', prediction=False, error="Descriptor columns do not match the model's feature set.")
